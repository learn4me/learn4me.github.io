angular.module('RDash', ['flow','ng.ueditor','ui.bootstrap', 'ui.router', 'ngCookies','ngStorage','permission','ngDialog','ngResource','ngSanitize']);
var baseUrl = "/api";
var ssoUrl = "http://sso.learn4me.com/login.php?refer=";
var imageUrl = "/dockerapi"
...
function MyCodeCtrl($scope,MyCodeService,$localStorage) {
    ...
    $scope.currentData = function(index){
        ...
        $scope.flag.is_show = true;
        $scope.flag.msg = "正在加载。。。";
        MyCodeService.getMyCode($scope.page.page,$scope.page.num,$scope.flag.key,function(err,data){
            if(data){
                if(data.length == 0){
                    $scope.flag.msg = "暂时没有数据。。您可以创建";
                }else{
